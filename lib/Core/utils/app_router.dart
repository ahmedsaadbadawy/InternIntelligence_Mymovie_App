...
import 'package:movie_app/presentaion/views/video/watch_video_screen.dart';
...
abstract class AppRouter {
  ...
  static const kwatchVideoScreen = '/WatchVideoScreen';
  ...
  static final router = GoRouter(
    routes: [
      ...
      GoRoute(
        path: kwatchVideoScreen,
        builder: (context, state) =>  WatchVideoScreen(
          videos: state.extra as List<VideoEntity>,
        ),
      ),
      GoRoute(
        path: kSearchScreen,
